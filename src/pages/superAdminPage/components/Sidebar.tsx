...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <aside className={`flex flex-col h-screen w-[280px] fixed left-0 top-0 bg-primary-container z-50 border-r border-outline-variant/30 transition-transform duration-300 ease-in-out ${
                isMobileOpen ? 'translate-x-0 shadow-2xl' : '-translate-x-full lg:translate-x-0'
            }`}>
                {/* Brand Section */}
                <div className="p-gutter flex items-center justify-between gap-3 border-b border-on-primary-fixed-variant/20">
                ...
                <nav className="px-3 py-4 mt-auto space-y-1">
                    ...
                    <button 
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-lg font-label-md text-label-md text-on-tertiary-container hover:text-surface-container-lowest hover:bg-on-primary-fixed-variant transition-colors duration-200"
                    >
